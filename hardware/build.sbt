...
lazy val commonSettings = Seq(
  ...
  libraryDependencies ++= Seq("edu.berkeley.cs" %% "chiseltest" % "0.5.6" % Test),
...
lazy val heteacc = dependOnChisel(project in file("."))
