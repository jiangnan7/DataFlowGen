...
abstract class stencil_floatDFIO(implicit val p: Parameters) extends Module with HasAccelParams {
...
class stencil_floatDF(implicit p: Parameters) extends stencil_floatDFIO()(p){
  ...
  val exe_block_2 = Module(new BasicBlockNode(NumInputs = 2, NumOuts = 11, NumPhi = 1, BID = 2))
  ...
  // val int_shl_7 = Module(new FPComputeNode(NumOuts = 1, ID = 7, opCode = "shl")(sign = false, Debug = false))

  // //%20 = arith.addi %12, %19 : index
  // val int_add_8 = Module(new FPComputeNode(NumOuts = 1, ID = 8, opCode = "Add")(sign = false, Debug = false))

  // //%21 = arith.addi %20, %18 : index
  // val int_add_9 = Module(new FPComputeNode(NumOuts = 1, ID = 9, opCode = "Add")(sign = false, Debug = false))
  

  val m0 = Module(new FloatChain(NumOps = 3, ID = 0, OpCodes = Array("Add","Add","Add"))(sign = false)(p))
  ...
  // val int_add_12 = Module(new FPComputeNode(NumOuts = 1, ID = 12, opCode = "Add")(sign = false, Debug = false))

  // //%25 = arith.shli %24, %c6 : index
  // val int_shl_13 = Module(new FPComputeNode(NumOuts = 1, ID = 13, opCode = "shl")(sign = false, Debug = false))

  // //%26 = arith.addi %25, %3 : index
  // val int_add_14 = Module(new FPComputeNode(NumOuts = 1, ID = 14, opCode = "Add")(sign = false, Debug = false))

  // //%27 = arith.addi %26, %18 : index
  // val int_add_15 = Module(new FPComputeNode(NumOuts = 1, ID = 15, opCode = "Add")(sign = false, Debug = false))


  val m1 = Module(new FloatChain(NumOps = 4, ID = 0, OpCodes = Array("Add","Add","Add","Add"))(sign = false)(p))

  for(i <- 0 until 4)
    m1.io.Out(i).ready := true.B
  ...
  // val int_mul_18 = Module(new FPComputeNode(NumOuts = 1, ID = 18, opCode = "Mul")(sign = false, Debug = false))

  //%31 = arith.addi %17, %30 : i32
  // val int_add_19 = Module(new FPComputeNode(NumOuts = 2, ID = 19, opCode = "Add")(sign = false, Debug = false))
  
  val m2 = Module(new FloatChain(NumOps = 2, ID = 0, OpCodes = Array("Mul","Add"))(sign = false)(p))

  for(i <- 0 until 2)
    m2.io.Out(i).ready := true.B
  ...
  // val int_shl_26 = Module(new FPComputeNode(NumOuts = 1, ID = 26, opCode = "shl")(sign = false, Debug = false))

  //%6 = arith.addi %5, %3 : index
  // val int_add_27 = Module(new FPComputeNode(NumOuts = 1, ID = 27, opCode = "Add")(sign = false, Debug = false))

  val m3 = Module(new FloatChain(NumOps = 2, ID = 0, OpCodes = Array("Add","Add"))(sign = false)(p))

  for(i <- 0 until 2)
    m3.io.Out(i).ready := true.B
  ...
  val int_add_33 = Module(new ComputeNode(NumOuts = 2, ID = 33, opCode = "Add")(sign = false, Debug = false))

  //%2 = arith.cmpi eq, %1, %c125 {Exe = "Loop"} : index
  val int_cmp_34 = Module(new ComputeNode(NumOuts = 1, ID = 34, opCode = "eq")(sign = false, Debug = false))
  ...
  m0.io.In(0) <> loop_0.io.OutLiveIn.elements("field0")(0)
  // int_shl_7.io.LeftIO <> loop_0.io.OutLiveIn.elements("field0")(0)
  m0.io.In(2) <> loop_0.io.OutLiveIn.elements("field0")(1)
  // int_add_8.io.LeftIO <> loop_0.io.OutLiveIn.elements("field0")(1)
  

  m1.io.In(0) <> loop_0.io.OutLiveIn.elements("field0")(2)
  ...
  m1.io.In(1) <> loop_0.io.OutLiveIn.elements("field2")(0)
  // int_add_12.io.LeftIO <> loop_0.io.OutLiveIn.elements("field2")(0)
  
  m1.io.In(3) <> loop_0.io.OutLiveIn.elements("field3")(0)
  ...
  m3.io.In(0) <> loop_2.io.OutLiveIn.elements("field3")(0)//loop_2.io.OutLiveIn.elements("field0")(0)
   ...
   * ================================================================== */
  loop_0.io.InLiveOut(0) <> m2.io.Out(2)
  ...
  loop_0.io.CarryDepenIn(0) <> m2.io.Out(2)
  ...
  m0.io.In(1) <> int_const_5.io.Out

  // int_shl_7.io.RightIO <> int_const_5.io.Out
  

  m1.io.In(2) <> int_const_6.io.Out
  ...
  m3.io.In(1) <> int_const_11.io.Out
  ...
  m2.io.In(2) <> loop_0.io.CarryDepenOut.elements("field0")(0)
  ...
  m1.io.In(4) <> loop_0.io.CarryDepenOut.elements("field1")(1)
  ...
  address_10.io.idx(0) <> m0.io.Out(3)//int_add_9.io.Out(0)

  load_11.GepAddr <> address_10.io.Out(0)

  m2.io.In(0) <> load_11.io.Out(0)
  ...
  address_16.io.idx(0) <> m1.io.Out(4)//int_add_15.io.Out(0)

  load_17.GepAddr <> address_16.io.Out(0)
  
  m2.io.In(1) <> load_17.io.Out(0)
  ...
  address_28.io.idx(0) <> m3.io.Out(2)//int_add_27.io.Out(0)
  ...
  m1.io.enable <> exe_block_0.io.Out(12)
  ...
  address_16.io.enable <> exe_block_0.io.Out(13)

  load_17.io.enable <> exe_block_0.io.Out(8)

  m2.io.enable <> exe_block_0.io.Out(7)
  // int_mul_18.io.enable <> exe_block_0.io.Out(8)

  // int_add_19.io.enable <> exe_block_0.io.Out(7)
  ...
  m3.io.enable <> exe_block_2.io.Out(6)
  ...
  int_cmp_31.io.enable <> exe_block_2.io.Out(7)
