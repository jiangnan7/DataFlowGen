...
class stencilDF(implicit p: Parameters) extends stencilDFIO()(p){
  ...
  val m0 = Module(new Chain(NumOps = 3, ID = 0, OpCodes = Array("shl","Add","Add"))(sign = false)(p))
  ...
  val m1 = Module(new Chain(NumOps = 4, ID = 0, OpCodes = Array("Add","shl","Add","Add"))(sign = false)(p))
  ...
  val m2 = Module(new Chain(NumOps = 2, ID = 0, OpCodes = Array("Mul","Add"))(sign = false)(p))
  ...
  val m3 = Module(new Chain(NumOps = 2, ID = 0, OpCodes = Array("shl","Add"))(sign = false)(p))
