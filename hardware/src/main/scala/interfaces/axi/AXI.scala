package heteacc.interfaces.axi

import chisel3._
import chisel3.util._
import chipsalliance.rocketchip.config._
import heteacc.config._
import utility.HeteaccGenericParameterizedBundle
...
abstract class AXIBase(params: AXIParams) extends HeteaccGenericParameterizedBundle(params)
