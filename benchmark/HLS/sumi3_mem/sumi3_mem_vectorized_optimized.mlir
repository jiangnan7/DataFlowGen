      ...
      %1 = dataflow.task : i32 {
        ...
        %2 = dataflow.for %arg1 = %c0 to %c200 step %c4 iter_args(%arg2 = %cst) -> (vector<4xi32>) {
          %4 = dataflow.execution : vector<4xi32> {
            %5 = vector.transfer_read %arg0[%arg1], %c0_i32 : memref<200xi32>, vector<4xi32>
            %6 = arith.muli %5, %5 {slp.group = 1 : i64, slp.lane = 0 : i64} : vector<4xi32>
            %7 = arith.muli %6, %5 {slp.group = 2 : i64, slp.lane = 0 : i64} : vector<4xi32>
            %8 = arith.addi %7, %arg2 : vector<4xi32>
            %true_0 = arith.constant true
            %9 = arith.addi %arg1, %c4 {Exe = "Loop"} : index
            dataflow.yield {execution_block = 1 : i32} %8 : vector<4xi32>
          }
