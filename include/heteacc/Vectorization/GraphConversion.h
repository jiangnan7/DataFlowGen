// Reference to
// https://github.com/esa-tu-darmstadt/spn-compiler/blob/master/mlir/include/Conversion/LoSPNtoCPU/Vectorization/SLP/GraphConversion.h
#ifndef MLIR_VECTORIZATION_GRAPH_CONVERSION_H
#define MLIR_VECTORIZATION_GRAPH_CONVERSION_H
...
public:
  ...
  const SmallPtrSet<Value, 32> &getComputedScalarValues() const {
    return permanentData.computedScalarValues;
  }
...
#endif // MLIR_VECTORIZATION_GRAPH_CONVERSION_H
